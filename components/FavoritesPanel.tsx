          ...
          >
            <div className="flex items-start justify-between gap-2 mb-2">
              ...
              <button
                ...
                aria-label={`Remove ${fav.spot_name} from saved spots`}
              >
                <svg aria-hidden="true" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth={2}>
